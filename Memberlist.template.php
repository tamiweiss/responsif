...
function template_main()
{
	...
	echo '
	<div id="memberlist" class="main_section">
		...
		<div id="Members" class="SectionContainer">
		<div class="pagesection">';
			if (!isset($context['old_search']))
				echo '
			<div class="LetterLinks">', $context['letter_links'], '</div>
		...
		<div id="mlist">
			<table id="MemberTable" >
				<thead class="TopicListHead">
					<tr>'; /* Tami changed to have fewer things in member list, not sure how to fix automated pull of column heads */
					echo '
						<th scope="col" class="Status">
								Status
						</th>
						<th scope="col" class="UserName">
							Username
						</th>
						<th scope="col" class="Position">
							Position
						</th>
						<th scope="col" class="DateRegistered">
							Joined
						</th>
						<th scope="col" colspan="2" class="Posts">
							Posts
						</th>		
					';
	...
	echo '
		...
		</div><!-- div#Members.SectionContainer ..>
	</div><!-- div.memberlist -->';
