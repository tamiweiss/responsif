...
function template_main()
{
	...
	{
		echo '
			<div class="windowbg ReportSent" id="profile_success">
				', $txt['report_sent'], '
			</div>';
	}
	...
	echo '
		<div id="TopicWrapper">
			...
			<h1 class="TopicHeadline">',$context['subject'],'</h1>';

	// Is this topic also a poll?
	if ($context['is_poll'])
	{
		echo '
			<div class="SectionContainer" id="PollOuter">
			<div id="poll">
				<h2 class="PollQuestion">
						<span class="PollBoxTitle">
						', $txt['poll'], ' <img src="', $settings['images_url'], '/topic/', $context['poll']['is_locked'] ? 'normal_poll_locked' : 'normal_poll', '.gif" alt="" class="icon" />
						</span>
	...
	if (!empty($context['poll']['expire_time']))
		echo '
					<p class="ExpireTime"><strong>', ($context['poll']['is_expired'] ? $txt['poll_expired_on'] : $txt['poll_expires_on']), ':</strong> ', $context['poll']['expire_time'], '</p>';
	...
	echo '
					<div id="pollmoderation">';
						...
						echo '
				</div><!-- div#pollmoderation -->

			</div><!-- div#poll_options -->
			
		</div><!-- div#poll -->
		</div><!-- div#PollOuter.SectionContainer -->
		';
	}
	...
	{
		echo '
		<div id="LinkedEvents" class="SectionContainer">
			<div class="linked_events">
				<h2 class="EventTitle">', $txt['calendar_linked_events'], '</h2>
				</div>
				<div class="content">
					<ul class="reset">';
	...
	$normal_buttons = array(
			...
			'new_topic' => array('test' => 'can_post_new', 'text' => 'new_topic', 'image' => 'new_topic.gif', 'lang' => true, 'url' => $scripturl . '?action=post;board=' . $context['current_board'] . '.0', 'active' => true), //Added for new topic btn. - tami
	...
	//this allows new topic button to exist here - tami
		...
		<div id="TopicDetail" class="SectionContainer">
			...
			// Show the page index... "Pages: [1]".
				'<div class="pagesection">
					<div class="nextlinks"><em>Topic:</em> ', $context['previous_next'], '</div>
					<div class="pagelinks"><em>', $txt['pages'], ':</em> ', $context['page_index'], !empty($modSettings['topbottomEnable']) ? $context['menu_separator'] . ' &nbsp;&nbsp;<a href="#lastPost"><strong>' . $txt['go_down'] . '</strong></a>' : '', '</div>
				</div>';
	...
	while ($message = $context['get_message']())
	{
		...
		echo '
				...
				echo '
							<ul class="ExtraInfo reset smalltext" id="msg_', $message['id'], '_extra_info">				
							
							
								<li class="Author">', $context['can_send_pm'] ? '<a href="' . $message['member']['online']['href'] . '" title="' . $message['member']['online']['label'] . '">' : '', '<img src="', $message['member']['online']['image_href'], '" alt="', $message['member']['online']['text'], '" />', $context['can_send_pm'] ? '</a>' : '';
		...
		echo '
						...
						<div class="postarea">
							<div class="flow_hidden">
								<div class="MsgMeta">
									<h2 id="subject_', $message['id'], '">
										<a href="', $message['href'], '" rel="nofollow">', $message['subject'], '</a>
									</h2>
									<div class="smalltext">&#171; <strong>', !empty($message['counter']) ? $txt['reply_noun'] . ' #' . $message['counter'] : '', ' ', 'posted', ':</strong> ', $message['time'], ' &#187;</div>
		...
		//commenting out quick modify in lieu of modify buttons
		...
		if ($settings['show_modify'] && !empty($message['modified']['name']))
			echo '
								<p>&#171; <em>', $txt['last_edit'], ': ', $message['modified']['time'], ' ', $txt['by'], ' ', $message['modified']['name'], '</em> &#187;</p>';
		...
		if (!empty($message['member']['custom_fields']))
		{
			...
			if ($shown)
				echo '
							...
							</div><!-- div.custom_fields_above_signature -->';
		}
		...
		if ($message['can_approve'] || $context['can_reply'] || $message['can_modify'] || $message['can_remove'] || $context['can_split'] || $context['can_restore_msg'])
			echo '
								<ul class="reset smalltext quickbuttons buttonlist">';
	...
	echo '
			<div class="pagesection">
				<div class="nextlinks"><em>Topic:</em> ', $context['previous_next'], '</div>
				<div class="pagelinks"><em>', $txt['pages'], ':</em> ', $context['page_index'], !empty($modSettings['topbottomEnable']) ? $context['menu_separator'] . ' &nbsp;&nbsp;<a href="#top"><strong>' . $txt['go_up'] . '</strong></a>' : '', '</div>
			</div>
