...
<div id="profileview" class="flow_auto">
	...
	<h1 >
		', $txt['summary'], ' <img src="', $settings['images_url'], '/icons/profile_sm.gif" alt="" class="icon" />
	</h1>
	...
	<div id="basicinfo">
		...
		<h2 class="username">', $context['member']['name'], ' <span class="position">', (!empty($context['member']['group']) ? $context['member']['group'] : $context['member']['post_group']), '</span></h2>
