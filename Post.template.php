...
function template_main()
{
	...
	echo '
			...
			<h1 class="catbg">', $context['page_title'], '</h1>
	...
	echo '					
						<dt> <span id="caption_board"> ', $txt['subject_category'], ':</span>
						</dt>
						<dd>
	...
	echo '
						<dt class="SubjectLabel">
							<span', isset($context['post_error']['no_subject']) ? ' class="error"' : '', ' id="caption_subject">', $txt['subject'], ':</span>
						</dt>
						<dd class="SubjectInput">
						...
						<dt class="clear_left message_icon">
							', $txt['message_icon'], ':
						</dt>
						<dd class="message_icon">
