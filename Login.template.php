...
function template_login()
{
	...
	echo '
		...
		<div id="Login" class="tborder login">
			
			<h1 class="catbg">
				', $txt['login'], '  <img src="', $settings['images_url'], '/icons/login_sm.gif" alt="" class="icon" />
			</h1>';
	...
	echo '
				<dl>
					<dt class="UserName">', $txt['username'], ':</dt>
					<dd class="UserName"><input type="text" name="user" size="20" value="', $context['default_username'], '" class="input_text" /></dd>
					<dt class="Password">', $txt['password'], ':</dt>
					<dd class="Password"><input type="password" name="passwrd" value="', $context['default_password'], '" size="20" class="input_password" /></dd>
				</dl>';

	if (!empty($modSettings['enableOpenID']))
		echo '<p><strong>&mdash;', $txt['or'], '&mdash;</strong></p>
				<dl>
					<dt class="OpenID">', $txt['openid'], ':</dt>
					<dd class="OpenID"><input type="text" name="openid_identifier" class="input_text openid_login" size="17" />&nbsp;<em><a href="', $scripturl, '?action=helpadmin;help=register_openid" onclick="return reqWin(this.href);" class="help">(?)</a></em></dd>
				</dl><hr />';

	echo '
				<dl>
					<dt class="LoggedInTime">', $txt['mins_logged_in'], ':</dt>
					<dd class="LoggedInTime"><input type="text" name="cookielength" size="4" maxlength="4" value="', $modSettings['cookieTime'], '"', $context['never_expire'] ? ' disabled="disabled"' : '', ' class="input_text" /></dd>
					<dt class="StayLoggedIn">', $txt['always_logged_in'], ':</dt>
					<dd  class="StayLoggedIn"><input type="checkbox" name="cookieneverexp"', $context['never_expire'] ? ' checked="checked"' : '', ' class="input_check" onclick="this.form.cookielength.disabled = this.checked;" /></dd>';
	// If they have deleted their account, give them a chance to change their mind.
	if (isset($context['login_show_undelete']))
		echo '
					<dt class="alert">', $txt['undelete_account'], ':</dt>
					<dd class="alert"><input type="checkbox" name="undelete" class="input_check" /></dd>';
	echo '
				</dl>
				<p><input type="submit" value="', $txt['login'], '" class="button_submit LoginButton" /></p>
				<p class="smalltext ForgotPassword"><a href="', $scripturl, '?action=reminder">', $txt['forgot_your_password'], '</a></p>
